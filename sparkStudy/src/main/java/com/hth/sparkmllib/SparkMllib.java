...
// * 　Spark是当下非常流行的数据分析框架，而其中的机器学习包Ｍllib也是其诸多亮点之一，相信很多人也像我那样想要快些上手spark。
// * 下面我将列出实现mllib分类的简明代码，代码中将简述训练集和样本集的结构，以及各分类算法的参数含义。
// * 分类模型包括朴素贝叶斯，ＳＶＭ，决策树以及随机森林。
//
//
// 注意
//
